 ...
 *
 *  2020-05-27 Juvenal Guzman (https://github.com/juvs)
 *      - Change the way events are create when update state, for some reason was not show latest state
 *      - Add send event when close and update, in order to upate current state
 *
